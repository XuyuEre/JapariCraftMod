...
public class EntityAIFollowSwimOwner extends EntityAIBase {
    ...
    public EntityAIFollowSwimOwner(EntityTameable tameableIn, double followSpeedIn, float minDistIn, float maxDistIn) {
        ...
        this.setMutexBits(3);
        if (!(tameableIn.getNavigator() instanceof PathNavigateSwimmer)) {
