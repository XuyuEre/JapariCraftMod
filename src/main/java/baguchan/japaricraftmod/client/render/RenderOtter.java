...
@OnlyIn(Dist.CLIENT)
public class RenderOtter extends RenderLiving<EntityOtter> {
    ...
    public RenderOtter(RenderManager renderManagerIn) {
        super(renderManagerIn, new ModelOtter(), 0.5F);
    ...
    protected void applyRotations(EntityOtter entityLiving, float ageInTicks, float rotationYaw, float partialTicks) {
